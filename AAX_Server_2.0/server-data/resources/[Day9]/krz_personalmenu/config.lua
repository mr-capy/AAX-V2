...
------=========================================================================================================-----------------
------=================================Config Dp Emote End Other Part is down here=============================---------------
...
-- GENERAL --
Config.MenuTitle = 'AAX ROLEPLAY' -- change it to you're server name
...
Config.Controls = {
	...
	HandsUP = {keyboard = Keys['~']}, --using theif handsup
...
--Other Files inside COnfig( --Other Files Here )
