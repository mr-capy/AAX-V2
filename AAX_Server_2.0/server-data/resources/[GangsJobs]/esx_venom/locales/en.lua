Locales['en'] = {
  ...
  ['venom_wear'] = 'venom Outfit',
  ['gilet_wear'] = 'Special Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~venom~s~',
  -- Vehicle interaction
