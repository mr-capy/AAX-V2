...
RegisterNetEvent('esx_garage:SetCharacter')
AddEventHandler('esx_garage:SetCharacter', function (playerData)
	_OwnPlayerData = playerData
end)

RegisterNetEvent('esx_garage:SetVehicleAndOwner')
AddEventHandler('esx_garage:SetVehicleAndOwner', function (vehicleAndOwner)
	_VehicleAndOwner = vehicleAndOwner;
end)

RegisterNetEvent('esx_garage:SetImpoundedVehicles')
AddEventHandler('esx_garage:SetImpoundedVehicles', function (impoundedVehicles)
	_ImpoundedVehicles = impoundedVehicles;
end)

RegisterNetEvent('esx_garage:VehicleUnimpounded')
AddEventHandler('esx_garage:VehicleUnimpounded', function (data, index)
...
RegisterNetEvent('esx_garage:CannotUnimpound')
AddEventHandler('esx_garage:CannotUnimpound', function ()
...
function ShowImpoundMenu (action)
	...
	if (vehicle ~= nil) then
		...
		TriggerServerEvent('esx_garage:GetCharacter', _XPlayer.identifier)
		TriggerServerEvent('esx_garage:GetVehicleAndOwner', v.plate)
		Citizen.Wait(500);
...
function ShowAdminTerminal ()
	...
	TriggerServerEvent('esx_garage:GetVehicles')
	Citizen.Wait(500)
...
function ShowRetrievalMenu ()
	...
	TriggerServerEvent('esx_garage:GetCharacter', _XPlayer.identifier)
	TriggerServerEvent('esx_garage:GetImpoundedVehicles', _XPlayer.identifier)
	Citizen.Wait(500)
...
RegisterNUICallback('impound', function(data, cb)
	...
	TriggerServerEvent('esx_garage:ImpoundVehicle', data)
...
RegisterNUICallback('unimpound', function(plate, cb)
	...
	TriggerServerEvent('esx_garage:UnimpoundVehicle', plate);
	DisableImpoundMenu();
	 cb('ok');
end)

RegisterNUICallback('unlock', function(plate, cb)
	TriggerServerEvent('esx_garage:UnlockVehicle', plate)
end)
----------------------------------------------------------------------------------------------------
-- Background tasks
----------------------------------------------------------------------------------------------------
