...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -222.688, y = -1330.3627, z = 30.8903},
	...
	ls2 = {
		Pos   = { x = -211.3869, y = -1324.84, z = 30.890},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {5.0, 10.00, 15.0, 20.0, 25.0}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {2.0, 4.0, 6.0, 8.0, 10.00, 12.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
