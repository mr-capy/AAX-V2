...
AddEventHandler('esx_vehicleshop:setVehicleOwned', function(vehicleProps)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('vehicle_belongs', vehicleProps.plate), length = 3000, style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
