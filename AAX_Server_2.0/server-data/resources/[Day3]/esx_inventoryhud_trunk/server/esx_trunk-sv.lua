          ...
          function(store)
            ...
            for i = 1, #coffre, 1 do
              if coffre[i].name == item then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = _U("invalid_quantity"), length = 3000, style = { ['background-color'] = '#ff0000', ['color'] = '#FFFFFF' } })
--[[
                  TriggerClientEvent(
	  ...
	  TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = _U("player_inv_no_space"), length = 3000, style = { ['background-color'] = '#ff0000', ['color'] = '#FFFFFF' } })
	  --[[
        TriggerClientEvent(
          "pNotify:SendNotification",
          _source,
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = _U("invalid_amount"), length = 3000, style = { ['background-color'] = '#ff0000', ['color'] = '#FFFFFF' } })		
...
TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = _U("insufficient_space"), length = 3000, style = { ['background-color'] = '#ff0000', ['color'] = '#FFFFFF' } })		
