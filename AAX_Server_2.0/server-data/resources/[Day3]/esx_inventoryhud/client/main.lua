...
exports['mythic_notify']:SendAlert('error', _U("players_nearby"), 3000, { ['background-color'] = '#ff0000', ['color'] = '#FFFFFF' })
...
exports['mythic_notify']:SendAlert('error', _U("player_nearby"), 3000, { ['background-color'] = '#ff0000', ['color'] = '#FFFFFF' })
    ...
    function()
        while true do
            ...
            if isInInventory then
                ...
                DisableControlAction(0, Keys["I"], true) -- Inventory
