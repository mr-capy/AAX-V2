...
function LoadLicenses (source)
  TriggerEvent('esx_license:getLicenses', source, function (licenses)
    TriggerClientEvent('esx_weaponshop:loadLicenses', source, licenses)
  end)
end
...
AddEventHandler('esx_weaponshop:buyLicense', function ()
...
ESX.RegisterServerCallback('esx_weaponshop:requestDBItems', function(source, cb)
...
AddEventHandler('esx_weaponshop:buyItem', function(itemName, price, zone)
  ...
  if zone=="BlackWeashop" then
    if account.money >= price then
		if itemName == "clip" then
			...
			TriggerClientEvent('esx:showNotification', _source, _U('buy') .. "Ammo Magazine")
		else
...
ESX.RegisterUsableItem('armor', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	  ...
	  TriggerClientEvent('esx_weaponshop:armor', source)
end)
