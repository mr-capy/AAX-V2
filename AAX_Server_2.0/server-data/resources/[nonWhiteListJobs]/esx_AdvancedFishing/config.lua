...
Config.zonesfarm = {
	farm = { coords = vector3(261.40, 6461.20, 31.79), name = 'Fields', color = 33, sprite = 514 },
	process = { coords = vector3(2309.8, 4886.20, 41.89), name = 'Rice Process', color = 33, sprite = 478 },
	cow = { coords = vector3(430.0, 6467.0, 28.77), name = 'Tractor Farm', color = 33, sprite = 473 },
	dealer = { coords = vector3(108.30, -1799.50, 27.09), name = 'Rice Dealer', color = 33, sprite = 280 },
}