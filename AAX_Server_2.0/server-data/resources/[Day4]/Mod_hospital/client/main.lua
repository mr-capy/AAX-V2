...
local pillboxTeleports = {
    { x = 359.81634521484, y = -586.36102294922, z = 44.202758789063, h = 64.513374328613, text = 'Press ~INPUT_CONTEXT~ ~s~to go to lower Pillbox Entrance' },
    { x = 359.81634521484, y = -586.36102294922, z = 44.202758789063, h = 245.85662841797, text = 'Press ~INPUT_CONTEXT~ ~s~to enter Pillbox Hospital' },
    { x = 359.81634521484, y = -586.36102294922, z = 44.202758789063, h = 245.85662841797, text = 'Press ~INPUT_CONTEXT~ ~s~to enter Pillbox Hospital' },
}
...
AddEventHandler('mythic_hospital:client:FinishServices', function()
	...
	if IsPedDeadOrDying(PlayerPedId()) then TriggerEvent('esx_ambulancejob:revive') end
        ...
        if distance < 10 then
            ...
            if not IsPedInAnyVehicle(PlayerPedId(), true) then
                if distance < 3 then
					...
					exports['progressBars']:startUI(10000, "Please Wait For Doctor..!")
					 Citizen.Wait(10000)
