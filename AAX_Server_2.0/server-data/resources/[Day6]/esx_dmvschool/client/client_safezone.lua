...
local zones = {
	...
	{ ['x'] = 297.474, ['y'] = -584.014, ['z'] = 31.238}, --Hospital
	{ ['x'] = -212.64, ['y'] = -1324.41, ['z'] = 30.89 },  --City Mechanic
	{ ['x'] = -41.235, ['y'] = -1102.225, ['z'] = 22.422 },  --City Car Dealer
	{ ['x'] = -295.27, ['y'] = -894.56, ['z'] = 31.08 },  --Garage A
	{ ['x'] = 213.9, ['y'] = -809.52, ['z'] = 31.01 },  --Garage B
	{ ['x'] = 1725.01, ['y'] = 3323.55, ['z'] = 41.22 },  --Garage C
	{ ['x'] = -1600.0, ['y'] = -3013.04, ['z'] = -79.01 }  --Night Club
...
Citizen.CreateThread(function()
	...
	for i = 1, #zones, 1 do
		...
		SetBlipSprite(szBlip, 4) -- Change the blip itself: https://marekkraus.sk/gtav/blips/list.html
		SetBlipColour(szBlip, 11)  --Change the blip color: https://gtaforums.com/topic/864881-all-blip-color-ids-pictured/
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if dist <= 50.0 then  ------------------------------------------------------------------------------ Here you can change the RADIUS of the Safe Zone. Remember, whatever you put here will DOUBLE because 
			...
			exports['mythic_notify']:SendAlert('inform', 'آپ سیف زون میں ہیں', 3000, { ['background-color'] = '#33cc33', ['color'] = '#ffffff' })
...
exports['mythic_notify']:SendAlert('error', 'اب آپ سیف زون میں نہیں ہیں', 3000, { ['background-color'] = 'ff0000', ['color'] = '#ffffff' })
...
--[[
	TriggerEvent("pNotify:SendNotification",{
		...
		exports['mythic_notify']:SendAlert('error', 'آپ سیف زون میں ہتھیار استعمال نہیں کرسکتے ہیں', 3000, { ['background-color'] = '#33cc33', ['color'] = '#ffffff' })
--[[
		TriggerEvent("pNotify:SendNotification",{
		...
		exports['mythic_notify']:SendAlert('error', 'آپ سیف زون میں ایسا نہیں کرسکتے ہیں', 3000, { ['background-color'] = 'ff0000', ['color'] = '#ffffff' })
